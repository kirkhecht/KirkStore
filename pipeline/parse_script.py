...
15-chapter structure matching the ElevenLabs project split.
"""
import json
import re
...
# ── Chapter definitions (matches the 15-part ElevenLabs project) ─────────────
CHAPTERS = {
    1:  {"title": "Creation to the Flood",
         "period": "Before recorded history", "setting": "primordial earth, Garden of Eden, pre-flood world"},
    2:  {"title": "The Covenant with Noah to Sarah's Death",
         "period": "Approx. 2350–1900 BC", "setting": "post-flood world, Mesopotamia, Canaan"},
    3:  {"title": "Jacob and Esau to Jacob Comes to Egypt",
         "period": "Approx. 1900–1600 BC", "setting": "Canaan, Haran, Egypt"},
    4:  {"title": "Exodus",
         "period": "Approx. 1500–1446 BC", "setting": "New Kingdom Egypt, Nile River valley, Sinai desert"},
    5:  {"title": "The Law and the Wilderness",
         "period": "Approx. 1446–1406 BC", "setting": "Sinai desert, Mount Sinai, Tabernacle in the wilderness"},
    6:  {"title": "The Promised Land",
         "period": "Approx. 1406–1050 BC", "setting": "Canaan, Jordan River valley, walled ancient cities"},
    7:  {"title": "First Samuel",
         "period": "Approx. 1100–1010 BC", "setting": "Shiloh, Philistine coast, Judean wilderness, Jerusalem"},
    8:  {"title": "Second Samuel — David's Reign",
         "period": "Approx. 1010–970 BC", "setting": "Jerusalem, David's palace, city of David"},
    9:  {"title": "The Glory of Solomon",
         "period": "Approx. 970–930 BC", "setting": "Jerusalem Temple, Solomon's palace, height of Israelite glory"},
    10: {"title": "Elijah and the Divided Kingdom",
         "period": "Approx. 930–850 BC", "setting": "Northern Israel, Samaria, Mount Carmel, Sinai wilderness"},
    11: {"title": "The Fall of the Kingdoms",
         "period": "Approx. 850–586 BC", "setting": "Israel and Judah under siege, Jerusalem walls, burning Temple"},
    12: {"title": "Daniel in Babylon",
         "period": "Approx. 605–539 BC", "setting": "Neo-Babylonian Babylon, plain of Dura, Persian palace"},
    13: {"title": "Ezekiel and Jeremiah",
         "period": "Approx. 627–571 BC", "setting": "Chebar River exile community, ruined Jerusalem, Babylonian streets"},
    14: {"title": "The Return — First Half",
         "period": "Approx. 538–480 BC", "setting": "Persian palace of Susa, road from Babylon, Jerusalem ruins"},
    15: {"title": "The Return — The Silence and the Star",
         "period": "Approx. 480–400 BC", "setting": "Post-exilic Jerusalem, Second Temple, Bethlehem road"},
}

# ── Section definitions per chapter ──────────────────────────────────────────
SECTIONS = {
    1: [
        ...
        {"title": "Adam and Eve",          "key_figures": ["Adam", "Eve"],            "emotion": "hopeful",       "setting": "Garden of Eden"},
    ...
    3: [
        ...
        {"title": "Closing Transition",    "key_figures": [],                         "emotion": "solemn",        "setting": "Egypt, growing Hebrew population"},
    ],
    4: [
    ...
    13: [
        ...
        {"title": "The Final Days",        "key_figures": ["Jeremiah", "Zedekiah"],   "emotion": "dark_and_tense","setting": "Jerusalem under siege, city walls"},
        {"title": "The Weeping Prophet",   "key_figures": ["Jeremiah"],               "emotion": "solemn",        "setting": "smoking ruins of Jerusalem"},
        {"title": "Closing Transition",    "key_figures": [],                         "emotion": "mysterious",    "setting": "road to Babylon, captive procession"},
    ],
    14: [
